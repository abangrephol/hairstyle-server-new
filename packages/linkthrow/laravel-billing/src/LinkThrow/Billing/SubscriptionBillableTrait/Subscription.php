<?php namespace LinkThrow\Billing\SubscriptionBillableTrait;
...
class Subscription
{
     ...
     * @param \LinkThrow\Billing\Gateways\SubscriptionInterface $subscription
     * @param mixed                                          $plan
     * @param array                                          $info
     * 
     * @return void
     */
    public function __construct(\Illuminate\Database\Eloquent\Model $model, \LinkThrow\Billing\Gateways\SubscriptionInterface $subscription = null, $plan = null, array $info = null)
    {
        if (null === $plan) {
