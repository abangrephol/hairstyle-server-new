...
@section('page-header')
    <h1>
        Frame Management
        <small>Edit Frame</small>
    </h1>
@endsection

@section('content')
    {!! Form::model($hairstyle,['route' => ['admin.master.hairstyle.update',$hairstyle->id] , 'files' => true , 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Frame</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <div id="singlePreview" class="clearfix">
                        <img id="imagePreview" src="{!! url('/uploads/hairstyles/'.$hairstyle->image) !!}" class="img-responsive" alt="Loading..">
                    </div>
                </div>
            </div><!--form control-->
                ...
                <div class="col-lg-10">
                    <select name="category_id" class="form-control">
                        ...
                        @foreach ($categories as $category)
                            <option value="{!! $category->id !!}" {!! $category->id == $hairstyle->category_id ? 'selected' : '' !!}>{!! $category->name !!}</option>
                        @endforeach
                    </select>
                </div>
            </div><!--form control-->
            ...
            @if(access()->hasRole('Administrator'))
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        <input type="checkbox" value="1" name="default" {{$hairstyle->default == 1 ? 'checked' : ''}} />
                    </div>
                </div><!--form control-->
                    ...
                    <div class="col-lg-10">
                        <select name="user_id" class="form-control">
                            ...
                            @foreach ($resellers as $reseller)
                                <option value="{!! $reseller->id !!}" {!! $reseller->id == $hairstyle->user_id ? 'selected' : '' !!}>{!! $reseller->name !!}</option>
                            @endforeach
                        </select>
                    </div>
                </div><!--form control-->
