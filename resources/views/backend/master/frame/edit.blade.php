...
@section('content')
    {!! Form::model($frame,['route' => ['admin.master.frame.update',$frame->id] , 'files' => true , 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
        ...
        <div class="box-body">
            ...
            @if(access()->hasRole('Administrator'))
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        <input type="checkbox" value="1" name="default" {{$frame->default == 1 ? 'checked' : ''}} />
                    </div>
                </div><!--form control-->
                    ...
                    <div class="col-lg-10">
                        <select name="user_id" class="form-control">
                            ...
                            @foreach ($resellers as $reseller)
                                <option value="{!! $reseller->id !!}" {!! $reseller->id == $frame->user_id ? 'selected' : '' !!}>{!! $reseller->name !!}</option>
                            @endforeach
                        </select>
                    </div>
                </div><!--form control-->
